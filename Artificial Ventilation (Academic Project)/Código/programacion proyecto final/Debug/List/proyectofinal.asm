...
_0x0:
	.DB  0x41,0x63,0x74,0x69,0x76,0x6F,0x0,0x45
	.DB  0x73,0x70,0x65,0x72,0x61,0x0,0x28,0x4F
	.DB  0x46,0x46,0x29,0x0,0x28,0x49,0x6E,0x73
	.DB  0x29,0x0,0x28,0x45,0x73,0x70,0x29,0x0
	.DB  0x28,0x50,0x65,0x65,0x70,0x29,0x0,0x50
	.DB  0x72,0x65,0x73,0x69,0x6F,0x6E,0x3A,0x20
	.DB  0x25,0x64,0x0,0x56,0x65,0x6C,0x3A,0x20
	.DB  0x25,0x64,0x0,0x54,0x3A,0x20,0x25,0x64
	.DB  0x0,0x45,0x73,0x74,0x61,0x64,0x6F,0x3A
	.DB  0x0,0x65,0x6E,0x20,0x65,0x73,0x70,0x65
	.DB  0x72,0x61,0x0,0x2C,0x0,0x45,0x74,0x3A
	.DB  0x20,0x25,0x64,0x20,0x56,0x65,0x6C,0x3A
	.DB  0x20,0x25,0x64,0x20,0x50,0x3A,0x20,0x25
	.DB  0x64,0x20,0xA,0x20,0x0
_0x2080060:
	.DB  0x1
_0x2080000:
...
; 0000 00A8 sprintf(texto5,"T: %d",(int)tiempo_espera);        //****************                                       //********** ...
	...
	ST   -Y,R31
	ST   -Y,R30
	LDS  R30,_tiempo_espera
	LDS  R31,_tiempo_espera+1
	CALL __CWD1
	CALL __PUTPARD1
	LDI  R24,4
	CALL _sprintf
...
; 0000 00D0 pres_max_glob = atoi(salida[2]);                //***************                                                        ...
	...
	LDD  R27,Y+8+1
	CALL _atoi
	STS  _pres_max_glob,R30
	STS  _pres_max_glob+1,R31
; 0000 00D1 tiempo_ins_glob = atoi(salida[3]);              //***************  Conversiones a Entero                                 ...
	LDD  R26,Y+10
	LDD  R27,Y+10+1
	CALL _atoi
	STS  _tiempo_ins_glob,R30
	STS  _tiempo_ins_glob+1,R31
; 0000 00D2 presion_PEEP = atoi(salida[4]);                 //***************                                                        ...
	LDD  R26,Y+12
	LDD  R27,Y+12+1
	CALL _atoi
	STS  _presion_PEEP,R30
	STS  _presion_PEEP+1,R31
; 0000 00D3 tiempo_espera = atoi(salida[5]);                //***************                                                        ...
	LDD  R26,Y+14
	LDD  R27,Y+14+1
	CALL _atoi
	STS  _tiempo_espera,R30
	STS  _tiempo_espera+1,R31
; 0000 00D4 }                                                                                                                        ...
	CALL __LOADLOCR4
	ADIW R28,63
	ADIW R28,25
...
; 0000 00E5 Speed_Control(vel_max);
	LDD  R26,Y+2
	RCALL _Speed_Control
; 0000 00E6 presion_ins=leer_presion();
	RCALL _leer_presion
	STS  _presion_ins,R30
	STS  _presion_ins+1,R31
...
; 0000 00E9 }while(count3 < tiempoins || presion_ins < pres_max_func );
	...
	LD   R30,Y
	LDD  R31,Y+1
	LDS  R26,_presion_ins
	LDS  R27,_presion_ins+1
	CP   R26,R30
	CPC  R27,R31
	BRSH _0x1B
_0x22:
...
; 0000 00F7 }while (presion_esp > PEEP);
	LD   R30,Y
	LDD  R31,Y+1
	LDS  R26,_presion_esp
	LDS  R27,_presion_esp+1
	CP   R30,R26
	CPC  R31,R27
	BRLO _0x25
; 0000 00F8 }
...
; 0000 0117       Display_Data (tiempo_ins_glob, presion_esp, estado,0);
	CALL SUBOPT_0xC
	LDS  R30,_presion_esp
	LDS  R31,_presion_esp+1
	CALL SUBOPT_0x8
	LDI  R26,LOW(0)
	LDI  R27,0
	RCALL _Display_Data
...
; 0000 011A       Inspiracion(tiempo_ins_glob,rpm_max,pres_max_glob);
	...
	ST   -Y,R31
	ST   -Y,R30
	LDS  R26,_pres_max_glob
	LDS  R27,_pres_max_glob+1
	RCALL _Inspiracion
; 0000 011B       Wait(tiempo_espera);
	CALL SUBOPT_0xD
; 0000 011C       Espiracion(presion_PEEP);
	LDS  R26,_presion_PEEP
	LDS  R27,_presion_PEEP+1
	RCALL _Espiracion
...
; .FSTART _strtok
	...
	SBIW R30,0
	BRNE _0x2060003
	LDS  R30,_p_S1030026000
	LDS  R31,_p_S1030026000+1
	SBIW R30,0
	BRNE _0x2060004
	LDI  R30,LOW(0)
	LDI  R31,HIGH(0)
...
_0x2060003:
	...
	BRNE _0x2060005
	LDI  R30,LOW(0)
	STS  _p_S1030026000,R30
	STS  _p_S1030026000+1,R30
	LDI  R30,LOW(0)
	LDI  R31,HIGH(0)
	RJMP _0x2120004
_0x2060005:
...
SUBOPT_0xA:
	CALL _leer_presion
	STS  _presion_esp,R30
	STS  _presion_esp+1,R31
	RET
...
;OPTIMIZER ADDED SUBROUTINE, CALLED 2 TIMES, CODE SIZE REDUCTION:1 WORDS
SUBOPT_0xC:
	LDS  R30,_tiempo_ins_glob
	LDS  R31,_tiempo_ins_glob+1
	ST   -Y,R31
	ST   -Y,R30
	RET
...
;OPTIMIZER ADDED SUBROUTINE, CALLED 2 TIMES, CODE SIZE REDUCTION:1 WORDS
SUBOPT_0xD:
	LDS  R26,_tiempo_espera
	LDS  R27,_tiempo_espera+1
	JMP  _Wait
